...
\begin{description}
	\item[Linie] ist ein Sammlung von Routen und beschreibt im öffentlichen Nahverkehr in der Regel eine Strecke von A nach B und umgedreht.
	\item[Journey] ist eine Fahrt auf einer Route, um Zeitmessungen für die Berechnung zu machen.
	\item[Route] ist ein Begriff, der eine konkrete Strecke von A nach B beschreibt.
\end{description}	
\clearpage
