\begin{table}[h]
	\begin{tabular}{|L{4.5cm}|L{3cm}|L{6.5cm}|}
		...
		\hline
		\textbf{Wintersemester 2017/18 (02.01.2018)} & Tobias Ullerich & 
			Dokumentation Rest API (Vehicle History) \\
		\hline
		\textbf{Wintersemester 2017/18 (03.01.2018)} & Tobias Ullerich & 
			Dokumentation Deployment/Runtime \\
		\hline
		\textbf{Wintersemester 2017/18 (04.01.2018)} & Stefan Neuberger & 
			Dokumentation OSM, GeoJSON, Problemstellung, Komponenten \\
		\hline
		\textbf{Wintersemester 2017/18 (04.01.2018)} & Pascal Dettmers & 
			Dokumentation Ausblick, Bibliotheken \\
		\hline
 	\end{tabular}
