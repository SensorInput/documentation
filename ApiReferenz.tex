...
% ##########    GET  /api/v1/vehicles    ###########
\subsection{Request für die historischen Daten aller Fahrzeuge} \label{sub:vehicle:list}
...
\subsection{Request für die historischen Daten eines Fahrzeugs} \label{sub:vehicle:list}
Anfrage aller historischen Fahrzeugdaten.
